                ...
                <div className="tableBottom">
                    <ul className="tableBottomMainList">
                        <li
                            ...
                            <a onClick={() => { hashHistory.replace({ pathname: '/company', query:{tab: 0} }) }}>合同内容</a>
                        </li>
                        <li
                            ...
                            <a onClick={() => { hashHistory.replace({ pathname: '/visitRecord', query: { tab: 1 } }) }}>任务记录</a>
                        </li>
                        <li
                            ...
                            <a onClick={() => { hashHistory.replace({ pathname: '/visitLists', query: { tab: 2 } }) }}>走访记录</a>
                        </li>
                        <li
                            ...
                            <a onClick={() => { hashHistory.replace({ pathname: '/meetingList', query: { tab: 3 } }) }}>会议纪要</a>
                        </li>
                        <li
                            ...
                            <a onClick={() => { hashHistory.replace({ pathname: '/PersonalList', query: { tab: 4 } }) }}>联系人</a>
                        </li>
                        <li
                            ...
                            <a onClick={() => { hashHistory.replace({ pathname: '/surveyHistoryStatic', query: { tab: 5 } }) }}>调研档案</a>
                        </li>
                        <li
                            ...
                            <a onClick={() => { hashHistory.replace({ pathname: '/QualityList', query: { tab: 6 } }) }}>验收</a>
                        </li>
                    </ul>
                    ...
                    <div className="addNewList" style={{display:this.state.slideUp?"block":"none"}}>
                        <ul>
                            ...
                            {/* <a onClick={() => { hashHistory.replace({ pathname: '/scene' }) }}><li>回访</li></a>
                            <a onClick={() => { hashHistory.replace({ pathname: '/meeting' }) }}><li>纪要</li></a>
                            <a onClick={() => { hashHistory.replace({ pathname: '/quality' }) }}><li>验收</li></a> */}
                        </ul>
                    </div>
                    <Modal
